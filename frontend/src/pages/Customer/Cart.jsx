                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            <input
                              type="number"
                              id={`quantity-${item.id}`}
                              className="bg-gray-50 w-14 border-b border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              placeholder="1"
                              value={item.quantity}
                              readOnly
                            />
